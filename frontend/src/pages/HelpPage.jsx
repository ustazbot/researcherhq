...
const HELP_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Import data luaran (CSV/XLSX)', a: 'Kumpul data di Google Forms atau tempat lain? Klik [Import from file] dalam Survey Builder → upload CSV/XLSX (had: 5MB, 1,000 baris, 60 kolum; 10 import sehari) → map kolum ke jenis soalan → confirm. Pilih SEKALI sama ada data pilot atau actual. Survey imported terus ke langkah Analisis dan struktur kekal berkunci (tiada publish/edit). Kolum bernama Email/Nama/No K/P/Telefon/Alamat ditanda ⚠ automatik — semakan pada nama kolum sahaja, sila semak kandungan sendiri sebelum import. Silap import? Padam survey dan import semula.' },
      { q: 'Interpretasi AI + Send to Editor', a: 'Klik [Interpret (3 credits)] pada mana-mana hasil analisis → AI tulis naratif akademik 2-5 ayat (BM/EN, default bahasa projek). Jaminan: semua angka dalam naratif disemak terhadap pengiraan sebenar — jika AI reka angka, naratif ditolak dan kredit TIDAK ditolak. Kemudian [Send to Editor] hantar naratif + ayat APA ke bab pilihan (default Bab 4) sebagai cadangan Accept/Reject — percuma. Jadual APA: export .docx dan tampal dalam dokumen tesis.' },
      { q: 'Adakah hasil analisis muktamad?', a: 'TIDAK. Hasil dijana automatik sebagai alat bantu — wajib semak dengan penyelia sebelum guna dalam tesis. Setiap naratif AI disertakan disclaimer semakan penyelia.' },
    ]
  },
  {
    id: 'faq',
